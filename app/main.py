...
from .routes import users, events, admin, shops, invoices, payments, user_snapshot,shop_snapshot
...
app.include_router(user_snapshot.router, prefix="/admin", tags=["admin"])
app.include_router(shop_snapshot.router, prefix="/admin", tags=["admin"])
