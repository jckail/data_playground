...
class OddsMaker(BaseModel):
    ...
    """
    max_fake_users_per_day: int = Field(default=25000, description="Maximum number of fake users that can be created per day")
    max_fake_shops_per_day: int = Field(default=20000, description="Maximum number of fake shops that can be created per day")
