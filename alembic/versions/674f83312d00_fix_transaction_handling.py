"""fix_transaction_handling

Revision ID: 674f83312d00
Revises: 
Create Date: 2024-11-27 22:38:47.674862
...
def upgrade() -> None:
    ...
    sa.Enum('ALL_PRODUCTS', 'SPECIFIC_PRODUCTS', 'SPECIFIC_CATEGORIES', 'MINIMUM_ORDER', name='promotionapplicability', schema='data_playground').create(op.get_bind())
    sa.Enum('DRAFT', 'SCHEDULED', 'ACTIVE', 'PAUSED', 'ENDED', 'CANCELLED', name='promotionstatus', schema='data_playground').create(op.get_bind())
    sa.Enum('PERCENTAGE', 'FIXED_AMOUNT', 'BUY_X_GET_Y', 'BUNDLE', 'FREE_SHIPPING', 'MINIMUM_PURCHASE', name='promotiontype', schema='data_playground').create(op.get_bind())
    sa.Enum('PURCHASE', 'SALE', 'RETURN', 'ADJUSTMENT', 'LOSS', 'RECOUNT', 'TRANSFER_IN', 'TRANSFER_OUT', 'RESERVATION', 'RESERVATION_RELEASE', name='inventorychangetype', schema='data_playground').create(op.get_bind())
    sa.Enum('PENDING', 'APPROVED', 'REJECTED', 'REPORTED', 'REMOVED', name='reviewstatus', schema='data_playground').create(op.get_bind())
    sa.Enum('SHOP', 'PRODUCT', name='reviewtype', schema='data_playground').create(op.get_bind())
    sa.Enum('STANDARD', 'EXPRESS', 'OVERNIGHT', 'LOCAL_PICKUP', 'INTERNATIONAL', name='shippingmethod', schema='data_playground').create(op.get_bind())
    sa.Enum('PENDING', 'PROCESSING', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'REFUNDED', 'ON_HOLD', 'RETURNED', name='orderstatus', schema='data_playground').create(op.get_bind())
    sa.Enum('ACTIVE', 'INACTIVE', 'OUT_OF_STOCK', 'DISCONTINUED', name='productstatus', schema='data_playground').create(op.get_bind())
    sa.Enum('ELECTRONICS', 'CLOTHING', 'FOOD', 'BOOKS', 'HOME', 'BEAUTY', 'SPORTS', 'TOYS', 'AUTOMOTIVE', 'HEALTH', 'OTHER', name='productcategory', schema='data_playground').create(op.get_bind())
    sa.Enum('USER', 'SHOP', 'SHOP_PRODUCT', 'USER_INVOICE', 'USER_PAYMENT', 'SHOP_ORDER', 'SHOP_REVIEW', 'SHOP_PROMOTION', 'USER_PAYMENT_METHOD', 'UNKNOWN', name='entitytype', schema='data_playground').create(op.get_bind())
    sa.Enum('ACCOUNT_CREATED', 'ACCOUNT_DELETED', 'ACCOUNT_DEACTIVATED', 'ACCOUNT_REACTIVATED', 'USER_LOGIN', 'USER_LOGOUT', 'PROFILE_UPDATED', 'PASSWORD_CHANGED', 'EMAIL_CHANGED', 'SHOP_CREATED', 'SHOP_DELETED', 'SHOP_UPDATED', 'SHOP_DEACTIVATED', 'SHOP_REACTIVATED', 'SHOP_SETTINGS_UPDATED', 'PRODUCT_CREATED', 'PRODUCT_UPDATED', 'PRODUCT_DELETED', 'PRODUCT_PRICE_CHANGED', 'PRODUCT_STATUS_CHANGED', 'PRODUCT_CATEGORY_CHANGED', 'ORDER_PLACED', 'ORDER_UPDATED', 'ORDER_CANCELLED', 'ORDER_PROCESSING', 'ORDER_SHIPPED', 'ORDER_DELIVERED', 'ORDER_RETURNED', 'ORDER_REFUNDED', 'PAYMENT_INITIATED', 'PAYMENT_PROCESSING', 'PAYMENT_SUCCEEDED', 'PAYMENT_FAILED', 'PAYMENT_REFUNDED', 'PAYMENT_PARTIALLY_REFUNDED', 'PAYMENT_DISPUTED', 'PAYMENT_DISPUTE_RESOLVED', 'PAYMENT_METHOD_ADDED', 'PAYMENT_METHOD_UPDATED', 'PAYMENT_METHOD_REMOVED', 'PAYMENT_METHOD_EXPIRED', 'PAYMENT_METHOD_DEFAULT_CHANGED', 'REVIEW_POSTED', 'REVIEW_UPDATED', 'REVIEW_DELETED', 'REVIEW_REPORTED', 'REVIEW_STATUS_CHANGED', 'REVIEW_VOTE_ADDED', 'REVIEW_VOTE_REMOVED', 'PROMOTION_CREATED', 'PROMOTION_UPDATED', 'PROMOTION_ACTIVATED', 'PROMOTION_DEACTIVATED', 'PROMOTION_USED', 'PROMOTION_EXPIRED', 'PROMOTION_LIMIT_REACHED', 'INVENTORY_UPDATED', 'INVENTORY_LOW', 'INVENTORY_OUT', 'INVENTORY_RESTOCKED', 'INVENTORY_ADJUSTED', 'INVENTORY_AUDIT', 'INVOICE_CREATED', 'INVOICE_UPDATED', 'INVOICE_PAID', 'INVOICE_CANCELLED', 'INVOICE_OVERDUE', 'INVOICE_REMINDER_SENT', 'METRICS_UPDATED', 'SHOP_METRICS_UPDATED', 'PRODUCT_METRICS_UPDATED', 'METRICS_ROLLUP_STARTED', 'METRICS_ROLLUP_COMPLETED', 'METRICS_ROLLUP_FAILED', 'SYSTEM_STARTUP', 'SYSTEM_SHUTDOWN', 'MAINTENANCE_STARTED', 'MAINTENANCE_COMPLETED', 'BACKUP_STARTED', 'BACKUP_COMPLETED', 'RESTORE_STARTED', 'RESTORE_COMPLETED', 'DATA_VALIDATION_STARTED', 'DATA_VALIDATION_COMPLETED', 'DATA_CORRUPTION_DETECTED', 'DATA_REPAIR_STARTED', 'DATA_REPAIR_COMPLETED', 'API_RATE_LIMIT_WARNING', 'API_RATE_LIMIT_EXCEEDED', 'API_THROTTLING_APPLIED', 'API_KEY_CREATED', 'API_KEY_REVOKED', 'SUSPICIOUS_ACTIVITY', 'LOGIN_ATTEMPT_FAILED', 'PASSWORD_RESET', 'TWO_FACTOR_ENABLED', 'TWO_FACTOR_DISABLED', 'ERROR_OCCURRED', 'SHOP_ERROR', 'PAYMENT_ERROR', 'SYSTEM_ERROR', 'UNKNOWN_EVENT', name='eventtype', schema='data_playground').create(op.get_bind())
    sa.Enum('ACTIVE', 'EXPIRED', 'SUSPENDED', 'DELETED', name='paymentmethodstatus', schema='data_playground').create(op.get_bind())
    sa.Enum('CREDIT_CARD', 'DEBIT_CARD', 'BANK_ACCOUNT', 'DIGITAL_WALLET', 'CRYPTO_WALLET', name='paymentmethodtype', schema='data_playground').create(op.get_bind())
    sa.Enum('IMMEDIATE', 'NET_15', 'NET_30', 'NET_45', 'NET_60', 'CUSTOM', name='paymentterms', schema='data_playground').create(op.get_bind())
    sa.Enum('DRAFT', 'PENDING', 'PROCESSING', 'COMPLETED', 'PAID', 'PARTIALLY_PAID', 'FAILED', 'OVERDUE', 'CANCELLED', 'REFUNDED', 'PARTIALLY_REFUNDED', name='paymentstatus', schema='data_playground').create(op.get_bind())
    sa.Enum('RETAIL', 'RESTAURANT', 'SERVICES', 'TECHNOLOGY', 'FASHION', 'HEALTH', 'ENTERTAINMENT', 'OTHER', name='shopcategory', schema='data_playground').create(op.get_bind())
    ...
    sa.Column('entity_type', postgresql.ENUM('USER', 'SHOP', 'SHOP_PRODUCT', 'USER_INVOICE', 'USER_PAYMENT', 'SHOP_ORDER', 'SHOP_REVIEW', 'SHOP_PROMOTION', 'USER_PAYMENT_METHOD', 'UNKNOWN', name='entitytype', schema='data_playground', create_type=False), nullable=False, comment='Type of entity being tracked'),
    ...
    sa.Column('event_type', postgresql.ENUM('ACCOUNT_CREATED', 'ACCOUNT_DELETED', 'ACCOUNT_DEACTIVATED', 'ACCOUNT_REACTIVATED', 'USER_LOGIN', 'USER_LOGOUT', 'PROFILE_UPDATED', 'PASSWORD_CHANGED', 'EMAIL_CHANGED', 'SHOP_CREATED', 'SHOP_DELETED', 'SHOP_UPDATED', 'SHOP_DEACTIVATED', 'SHOP_REACTIVATED', 'SHOP_SETTINGS_UPDATED', 'PRODUCT_CREATED', 'PRODUCT_UPDATED', 'PRODUCT_DELETED', 'PRODUCT_PRICE_CHANGED', 'PRODUCT_STATUS_CHANGED', 'PRODUCT_CATEGORY_CHANGED', 'ORDER_PLACED', 'ORDER_UPDATED', 'ORDER_CANCELLED', 'ORDER_PROCESSING', 'ORDER_SHIPPED', 'ORDER_DELIVERED', 'ORDER_RETURNED', 'ORDER_REFUNDED', 'PAYMENT_INITIATED', 'PAYMENT_PROCESSING', 'PAYMENT_SUCCEEDED', 'PAYMENT_FAILED', 'PAYMENT_REFUNDED', 'PAYMENT_PARTIALLY_REFUNDED', 'PAYMENT_DISPUTED', 'PAYMENT_DISPUTE_RESOLVED', 'PAYMENT_METHOD_ADDED', 'PAYMENT_METHOD_UPDATED', 'PAYMENT_METHOD_REMOVED', 'PAYMENT_METHOD_EXPIRED', 'PAYMENT_METHOD_DEFAULT_CHANGED', 'REVIEW_POSTED', 'REVIEW_UPDATED', 'REVIEW_DELETED', 'REVIEW_REPORTED', 'REVIEW_STATUS_CHANGED', 'REVIEW_VOTE_ADDED', 'REVIEW_VOTE_REMOVED', 'PROMOTION_CREATED', 'PROMOTION_UPDATED', 'PROMOTION_ACTIVATED', 'PROMOTION_DEACTIVATED', 'PROMOTION_USED', 'PROMOTION_EXPIRED', 'PROMOTION_LIMIT_REACHED', 'INVENTORY_UPDATED', 'INVENTORY_LOW', 'INVENTORY_OUT', 'INVENTORY_RESTOCKED', 'INVENTORY_ADJUSTED', 'INVENTORY_AUDIT', 'INVOICE_CREATED', 'INVOICE_UPDATED', 'INVOICE_PAID', 'INVOICE_CANCELLED', 'INVOICE_OVERDUE', 'INVOICE_REMINDER_SENT', 'METRICS_UPDATED', 'SHOP_METRICS_UPDATED', 'PRODUCT_METRICS_UPDATED', 'METRICS_ROLLUP_STARTED', 'METRICS_ROLLUP_COMPLETED', 'METRICS_ROLLUP_FAILED', 'SYSTEM_STARTUP', 'SYSTEM_SHUTDOWN', 'MAINTENANCE_STARTED', 'MAINTENANCE_COMPLETED', 'BACKUP_STARTED', 'BACKUP_COMPLETED', 'RESTORE_STARTED', 'RESTORE_COMPLETED', 'DATA_VALIDATION_STARTED', 'DATA_VALIDATION_COMPLETED', 'DATA_CORRUPTION_DETECTED', 'DATA_REPAIR_STARTED', 'DATA_REPAIR_COMPLETED', 'API_RATE_LIMIT_WARNING', 'API_RATE_LIMIT_EXCEEDED', 'API_THROTTLING_APPLIED', 'API_KEY_CREATED', 'API_KEY_REVOKED', 'SUSPICIOUS_ACTIVITY', 'LOGIN_ATTEMPT_FAILED', 'PASSWORD_RESET', 'TWO_FACTOR_ENABLED', 'TWO_FACTOR_DISABLED', 'ERROR_OCCURRED', 'SHOP_ERROR', 'PAYMENT_ERROR', 'SYSTEM_ERROR', 'UNKNOWN_EVENT', name='eventtype', schema='data_playground', create_type=False), nullable=False, comment='Type of event that occurred (e.g., user creation, payment, etc.)'),
    ...
    sa.Column('category', postgresql.ENUM('RETAIL', 'RESTAURANT', 'SERVICES', 'TECHNOLOGY', 'FASHION', 'HEALTH', 'ENTERTAINMENT', 'OTHER', name='shopcategory', schema='data_playground', create_type=False), nullable=False, comment="Primary category of the shop's business"),
    ...
    sa.Column('method_type', postgresql.ENUM('CREDIT_CARD', 'DEBIT_CARD', 'BANK_ACCOUNT', 'DIGITAL_WALLET', 'CRYPTO_WALLET', name='paymentmethodtype', schema='data_playground', create_type=False), nullable=False, comment='Type of payment method'),
    sa.Column('status', postgresql.ENUM('ACTIVE', 'EXPIRED', 'SUSPENDED', 'DELETED', name='paymentmethodstatus', schema='data_playground', create_type=False), nullable=False, comment='Current status of the payment method'),
    ...
    sa.Column('status', postgresql.ENUM('DRAFT', 'PENDING', 'PROCESSING', 'COMPLETED', 'PAID', 'PARTIALLY_PAID', 'FAILED', 'OVERDUE', 'CANCELLED', 'REFUNDED', 'PARTIALLY_REFUNDED', name='paymentstatus', schema='data_playground', create_type=False), nullable=False, comment='Current status of the invoice'),
    sa.Column('payment_terms', postgresql.ENUM('IMMEDIATE', 'NET_15', 'NET_30', 'NET_45', 'NET_60', 'CUSTOM', name='paymentterms', schema='data_playground', create_type=False), nullable=False, comment='Payment terms for this invoice'),
    ...
    sa.Column('status', postgresql.ENUM('PENDING', 'PROCESSING', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'REFUNDED', 'ON_HOLD', 'RETURNED', name='orderstatus', schema='data_playground', create_type=False), nullable=False, comment='Current status of the order'),
    ...
    sa.Column('shipping_method', postgresql.ENUM('STANDARD', 'EXPRESS', 'OVERNIGHT', 'LOCAL_PICKUP', 'INTERNATIONAL', name='shippingmethod', schema='data_playground', create_type=False), nullable=True, comment='Selected shipping method'),
    ...
    sa.Column('category', postgresql.ENUM('ELECTRONICS', 'CLOTHING', 'FOOD', 'BOOKS', 'HOME', 'BEAUTY', 'SPORTS', 'TOYS', 'AUTOMOTIVE', 'HEALTH', 'OTHER', name='productcategory', schema='data_playground', create_type=False), nullable=False, comment='Category the product belongs to'),
    sa.Column('status', postgresql.ENUM('ACTIVE', 'INACTIVE', 'OUT_OF_STOCK', 'DISCONTINUED', name='productstatus', schema='data_playground', create_type=False), nullable=False, comment='Current status of the product'),
    ...
    sa.Column('promotion_type', postgresql.ENUM('PERCENTAGE', 'FIXED_AMOUNT', 'BUY_X_GET_Y', 'BUNDLE', 'FREE_SHIPPING', 'MINIMUM_PURCHASE', name='promotiontype', schema='data_playground', create_type=False), nullable=False, comment='Type of discount offered'),
    sa.Column('status', postgresql.ENUM('DRAFT', 'SCHEDULED', 'ACTIVE', 'PAUSED', 'ENDED', 'CANCELLED', name='promotionstatus', schema='data_playground', create_type=False), nullable=False, comment='Current status of the promotion'),
    ...
    sa.Column('applicability', postgresql.ENUM('ALL_PRODUCTS', 'SPECIFIC_PRODUCTS', 'SPECIFIC_CATEGORIES', 'MINIMUM_ORDER', name='promotionapplicability', schema='data_playground', create_type=False), nullable=False, comment='What items the promotion applies to'),
    ...
    sa.Column('status', postgresql.ENUM('DRAFT', 'PENDING', 'PROCESSING', 'COMPLETED', 'PAID', 'PARTIALLY_PAID', 'FAILED', 'OVERDUE', 'CANCELLED', 'REFUNDED', 'PARTIALLY_REFUNDED', name='paymentstatus', schema='data_playground', create_type=False), nullable=False, comment='Current status of the payment'),
    sa.Column('method', postgresql.ENUM('CREDIT_CARD', 'DEBIT_CARD', 'BANK_ACCOUNT', 'DIGITAL_WALLET', 'CRYPTO_WALLET', name='paymentmethodtype', schema='data_playground', create_type=False), nullable=False, comment='Method used for payment'),
    ...
    sa.Column('change_type', postgresql.ENUM('PURCHASE', 'SALE', 'RETURN', 'ADJUSTMENT', 'LOSS', 'RECOUNT', 'TRANSFER_IN', 'TRANSFER_OUT', 'RESERVATION', 'RESERVATION_RELEASE', name='inventorychangetype', schema='data_playground', create_type=False), nullable=False, comment='Type of inventory change that occurred'),
    ...
    sa.Column('review_type', postgresql.ENUM('SHOP', 'PRODUCT', name='reviewtype', schema='data_playground', create_type=False), nullable=False, comment='Whether this is a shop or product review'),
    sa.Column('status', postgresql.ENUM('PENDING', 'APPROVED', 'REJECTED', 'REPORTED', 'REMOVED', name='reviewstatus', schema='data_playground', create_type=False), nullable=False, comment='Current moderation status of the review'),
...
def downgrade() -> None:
    ...
    sa.Enum('RETAIL', 'RESTAURANT', 'SERVICES', 'TECHNOLOGY', 'FASHION', 'HEALTH', 'ENTERTAINMENT', 'OTHER', name='shopcategory', schema='data_playground').drop(op.get_bind())
    sa.Enum('DRAFT', 'PENDING', 'PROCESSING', 'COMPLETED', 'PAID', 'PARTIALLY_PAID', 'FAILED', 'OVERDUE', 'CANCELLED', 'REFUNDED', 'PARTIALLY_REFUNDED', name='paymentstatus', schema='data_playground').drop(op.get_bind())
    sa.Enum('IMMEDIATE', 'NET_15', 'NET_30', 'NET_45', 'NET_60', 'CUSTOM', name='paymentterms', schema='data_playground').drop(op.get_bind())
    sa.Enum('CREDIT_CARD', 'DEBIT_CARD', 'BANK_ACCOUNT', 'DIGITAL_WALLET', 'CRYPTO_WALLET', name='paymentmethodtype', schema='data_playground').drop(op.get_bind())
    sa.Enum('ACTIVE', 'EXPIRED', 'SUSPENDED', 'DELETED', name='paymentmethodstatus', schema='data_playground').drop(op.get_bind())
    sa.Enum('ACCOUNT_CREATED', 'ACCOUNT_DELETED', 'ACCOUNT_DEACTIVATED', 'ACCOUNT_REACTIVATED', 'USER_LOGIN', 'USER_LOGOUT', 'PROFILE_UPDATED', 'PASSWORD_CHANGED', 'EMAIL_CHANGED', 'SHOP_CREATED', 'SHOP_DELETED', 'SHOP_UPDATED', 'SHOP_DEACTIVATED', 'SHOP_REACTIVATED', 'SHOP_SETTINGS_UPDATED', 'PRODUCT_CREATED', 'PRODUCT_UPDATED', 'PRODUCT_DELETED', 'PRODUCT_PRICE_CHANGED', 'PRODUCT_STATUS_CHANGED', 'PRODUCT_CATEGORY_CHANGED', 'ORDER_PLACED', 'ORDER_UPDATED', 'ORDER_CANCELLED', 'ORDER_PROCESSING', 'ORDER_SHIPPED', 'ORDER_DELIVERED', 'ORDER_RETURNED', 'ORDER_REFUNDED', 'PAYMENT_INITIATED', 'PAYMENT_PROCESSING', 'PAYMENT_SUCCEEDED', 'PAYMENT_FAILED', 'PAYMENT_REFUNDED', 'PAYMENT_PARTIALLY_REFUNDED', 'PAYMENT_DISPUTED', 'PAYMENT_DISPUTE_RESOLVED', 'PAYMENT_METHOD_ADDED', 'PAYMENT_METHOD_UPDATED', 'PAYMENT_METHOD_REMOVED', 'PAYMENT_METHOD_EXPIRED', 'PAYMENT_METHOD_DEFAULT_CHANGED', 'REVIEW_POSTED', 'REVIEW_UPDATED', 'REVIEW_DELETED', 'REVIEW_REPORTED', 'REVIEW_STATUS_CHANGED', 'REVIEW_VOTE_ADDED', 'REVIEW_VOTE_REMOVED', 'PROMOTION_CREATED', 'PROMOTION_UPDATED', 'PROMOTION_ACTIVATED', 'PROMOTION_DEACTIVATED', 'PROMOTION_USED', 'PROMOTION_EXPIRED', 'PROMOTION_LIMIT_REACHED', 'INVENTORY_UPDATED', 'INVENTORY_LOW', 'INVENTORY_OUT', 'INVENTORY_RESTOCKED', 'INVENTORY_ADJUSTED', 'INVENTORY_AUDIT', 'INVOICE_CREATED', 'INVOICE_UPDATED', 'INVOICE_PAID', 'INVOICE_CANCELLED', 'INVOICE_OVERDUE', 'INVOICE_REMINDER_SENT', 'METRICS_UPDATED', 'SHOP_METRICS_UPDATED', 'PRODUCT_METRICS_UPDATED', 'METRICS_ROLLUP_STARTED', 'METRICS_ROLLUP_COMPLETED', 'METRICS_ROLLUP_FAILED', 'SYSTEM_STARTUP', 'SYSTEM_SHUTDOWN', 'MAINTENANCE_STARTED', 'MAINTENANCE_COMPLETED', 'BACKUP_STARTED', 'BACKUP_COMPLETED', 'RESTORE_STARTED', 'RESTORE_COMPLETED', 'DATA_VALIDATION_STARTED', 'DATA_VALIDATION_COMPLETED', 'DATA_CORRUPTION_DETECTED', 'DATA_REPAIR_STARTED', 'DATA_REPAIR_COMPLETED', 'API_RATE_LIMIT_WARNING', 'API_RATE_LIMIT_EXCEEDED', 'API_THROTTLING_APPLIED', 'API_KEY_CREATED', 'API_KEY_REVOKED', 'SUSPICIOUS_ACTIVITY', 'LOGIN_ATTEMPT_FAILED', 'PASSWORD_RESET', 'TWO_FACTOR_ENABLED', 'TWO_FACTOR_DISABLED', 'ERROR_OCCURRED', 'SHOP_ERROR', 'PAYMENT_ERROR', 'SYSTEM_ERROR', 'UNKNOWN_EVENT', name='eventtype', schema='data_playground').drop(op.get_bind())
    sa.Enum('USER', 'SHOP', 'SHOP_PRODUCT', 'USER_INVOICE', 'USER_PAYMENT', 'SHOP_ORDER', 'SHOP_REVIEW', 'SHOP_PROMOTION', 'USER_PAYMENT_METHOD', 'UNKNOWN', name='entitytype', schema='data_playground').drop(op.get_bind())
    sa.Enum('ELECTRONICS', 'CLOTHING', 'FOOD', 'BOOKS', 'HOME', 'BEAUTY', 'SPORTS', 'TOYS', 'AUTOMOTIVE', 'HEALTH', 'OTHER', name='productcategory', schema='data_playground').drop(op.get_bind())
    sa.Enum('ACTIVE', 'INACTIVE', 'OUT_OF_STOCK', 'DISCONTINUED', name='productstatus', schema='data_playground').drop(op.get_bind())
    sa.Enum('PENDING', 'PROCESSING', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'REFUNDED', 'ON_HOLD', 'RETURNED', name='orderstatus', schema='data_playground').drop(op.get_bind())
    sa.Enum('STANDARD', 'EXPRESS', 'OVERNIGHT', 'LOCAL_PICKUP', 'INTERNATIONAL', name='shippingmethod', schema='data_playground').drop(op.get_bind())
    sa.Enum('SHOP', 'PRODUCT', name='reviewtype', schema='data_playground').drop(op.get_bind())
    sa.Enum('PENDING', 'APPROVED', 'REJECTED', 'REPORTED', 'REMOVED', name='reviewstatus', schema='data_playground').drop(op.get_bind())
    sa.Enum('PURCHASE', 'SALE', 'RETURN', 'ADJUSTMENT', 'LOSS', 'RECOUNT', 'TRANSFER_IN', 'TRANSFER_OUT', 'RESERVATION', 'RESERVATION_RELEASE', name='inventorychangetype', schema='data_playground').drop(op.get_bind())
    sa.Enum('PERCENTAGE', 'FIXED_AMOUNT', 'BUY_X_GET_Y', 'BUNDLE', 'FREE_SHIPPING', 'MINIMUM_PURCHASE', name='promotiontype', schema='data_playground').drop(op.get_bind())
    sa.Enum('DRAFT', 'SCHEDULED', 'ACTIVE', 'PAUSED', 'ENDED', 'CANCELLED', name='promotionstatus', schema='data_playground').drop(op.get_bind())
    sa.Enum('ALL_PRODUCTS', 'SPECIFIC_PRODUCTS', 'SPECIFIC_CATEGORIES', 'MINIMUM_ORDER', name='promotionapplicability', schema='data_playground').drop(op.get_bind())
    # ### end Alembic commands ###
